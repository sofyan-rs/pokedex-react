...
const PokemonMoves = () => {
    ...
    const { data: pokemonDetails, error } = useFetch('https://pokeapi.co/api/v2/pokemon/' + name);
    ...
    return (
        <>
            ...
            {pokemonDetails && (
                <>
                    <header className='relative overflow-hidden bg-gray-900 drop-shadow-2xl p-5 md:p-7 sticky z-10 top-0'>
